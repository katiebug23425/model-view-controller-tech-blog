...
// Delete the post
        ...
        const updateTechBlogPostButton = document.querySelector("#update-tech-blog-post");

        if (updateTechBlogPostButton) {
            updateTechBlogPostButton.addEventListener("click", updateTechBlogPostFormHandler);
        }

        const deleteTechBlogPostButton = document.querySelector("#delete-tech-blog-post");

        if (deleteTechBlogPostButton) {
        deleteTechBlogPostButton.addEventListener("click", deleteTechBlogPostFormHandler);
        }
        };